<form method="POST" action="{{ route('items.store') }}" class="modal-part" id="modal-barang">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('stock') is-invalid @enderror" name="stock" required autofocus>
        @error('stock')
        <span class="text-danger" role="alert">
            {{ $message }}
        </span>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                <button class="btn btn-primary" type="button" onclick="checkPPN()">{{ __('Ambil Data') }}</button>
            </div>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input class="form-control @error('profit') is-invalid @enderror" type="text" name="profit" id="profit"
                max="100">
            <div class="input-group-prepend">
                <div class="input-group-text">
                    {{ __('%') }}
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input class="form-control currency @error('sell_price') is-invalid @enderror" type="text" name="sell_price"
                id="sell_price">
            <div class="input-group-append">
                <button class="btn btn-primary" type="button" onclick="checkPrice()">{{ __('Ambil Data') }}</button>
            </div>
        </div>
        @error('sell_price')
        <span class="text-danger" role="alert">
