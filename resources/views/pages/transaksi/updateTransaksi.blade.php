...
@section('title', __('pages.title').__(' | Edit Transaksi'))
@section('titleContent', __('Edit Transaksi'))
@section('breadcrumb', __('Master'))
@section('morebreadcrumb')
<div class="breadcrumb-item active">{{ __('Transaksi') }}</div>
<div class="breadcrumb-item active">{{ __('Edit Transaksi') }}</div>
@endsection

@section('content')
<h2 class="section-title">{{ $transaction->code }}</h2>
